...
**Project**: jupiter-breeze-landing 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: make a site about jupiter ladnign page  
...
```sh
git clone https://github.com/GPT-Engineer-App-Dev/jupiter-breeze-landing.git
cd jupiter-breeze-landing
npm i
